#ifndef NEMO_CUDA_PLUGINS_IF_CURR_ALPHA_CU
#define NEMO_CUDA_PLUGINS_IF_CURR_ALPHA_CU
...
/*! \file IF_curr_alpha.cu Neuron update CUDA kernel for current-based
...
#include <nemo/plugins/IF_curr_alpha.h>
